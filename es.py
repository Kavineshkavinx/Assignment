...
def indexData(p_collection_name, p_exclude_column):
    ...
    with open('D:\Employee Sample Data 1.csv', newline='') as csvfile:
...
v_nameCollection = 'hash_kavinesh'  # Replace 'YourName' with your actual name
v_phoneCollection = 'hash_6107'           # Replace '1234' with the last four digits of your phone number
